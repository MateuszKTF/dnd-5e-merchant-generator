...
- [x] 1.1 Unit tests pass: `npm test` — 85f277a
- [x] 1.2 Type checking passes: `npx astro check` — 85f277a
- [x] 1.3 Production build succeeds: `npm run build` — 85f277a
- [x] 1.4 Linting passes: `npm run lint` — 85f277a
